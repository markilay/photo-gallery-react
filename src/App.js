...
function App() {
  ...
  const [modalWindowPicture, setModalWindowPicture] = useState(null);
	...
	return (
		<div className='App'>
			<ModalWindow modalWindowPicture={modalWindowPicture}  />
			<Header />
			<Search
				photos={photos}
				setPhotos={setPhotos}
			...
			<InfiniteScroll
				...
				loader={<Loader />}
			>
				<Gallery photos={photos} setModalWindowPicture={setModalWindowPicture} />
			</InfiniteScroll>
		</div>
	);
}
